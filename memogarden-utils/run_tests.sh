#!/bin/bash
# MemoGarden Utils Test Runner
#
# Standardized test entrypoint for memogarden-utils.
...
#   ./run_tests.sh tests/test_datetime.py
#   ./run_tests.sh --cov=utils --cov-report=term-missing
...
export PROJECT_NAME="memogarden-utils"

# Python module name for coverage (e.g., "api", "system", "utils")
export MODULE_NAME="utils"
...
export VIRTUAL_ENV="/home/kureshii/memogarden/memogarden-utils/.venv"
